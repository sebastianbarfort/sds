...
```{r, warnings = FALSE, results = "hide", echo = FALSE, warning = FALSE, message = FALSE}
library("readxl")
...
dt.t = full_join(df, df2, by = c("name" = "X1"))
...
|Pallesen, Peter Mølgaard            |Student |    20|
|Pedersen, Jesper Hybel              |Student |    20|
|Pedersen, Pernille Helander         |Student |    20|
...
|Sørensen, Asger Johannes Bay        |Student |    24|
